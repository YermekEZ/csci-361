...
//		out1.println("<html><body><table><tr><th>Date</th><th>Departure</th><th>Arrival</th>");
		try {
			...
			ResultSet r;
			String query ="select  Ticket.RouteID, User.Fname, User.Lname, Ticket.Seat_Number, Ticket.Status, Ticket.Passenger, Ticket.TrainID " +"from Ticket left join User on User.UserID = Ticket.Passenger " + 	"where Ticket.RouteID = (select Route.RouteID " + "From Route Where  ";
